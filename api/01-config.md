...
> Pour builder ou initialiser l'API, utiliser le CLI FoundationKit. Voir [CLI](./00-cli.md).

```bash
fdn build api     # Build pour la production
fdn init api      # Installe les dépendances + migrations + build
```
