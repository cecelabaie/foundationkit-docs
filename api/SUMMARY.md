...
1. [CLI](./00-cli.md)
2. [Configuration](./01-config.md)
3. [Database](./02-database.md)
4. [Diagrams](./03-diagrams.md)
5. [Faker](./04-faker.md)
6. [Filters](./05-filters.md)
7. [Responses](./06-responses.md)
8. [Gestion de la session](./07-session.md)
9. [Guards](./08-guards.md)
10. [Media](./09-media.md)
11. [Prisma](./10-prisma.md)
12. [Structure domain](./11-structure-domain.md)
13. [Routes](./12-routes.md)
14. [Swagger](./13-swagger.md)
15. [Tests](./14-tests.md)
16. [Traductions](./15-traductions.md)
17. [Guide IA : Contribuer à l'API](./16-agent-ia.md)

## Résumés

### CLI
Présente le CLI officiel `fdn` : installation, connexion, et commandes pour initialiser et builder l'API (`fdn init api`, `fdn build api`). Point d'entrée recommandé avant de consulter la configuration.
